            ...
            <section className="px-6 py-16">
                <div className="container mx-auto flex-col md:flex-row flex justify-center gap-x-6 gap-y-5">
                    ...
                    <div className="w-full md:w-1/2 relative z-10">
                        ...
                        <h2 className="stock-heading-white text-white text-[2.75rem] lg:text-[4.5rem] 2xl:text-[6rem] md:text-left text-center w-full lg:w-fit absolute -z-10 top-1/2">
                            Rusy A Laurent
                        </h2>
                    </div>
                </div>
                ...
                <div className="container mx-auto flex-col md:flex-row flex justify-center gap-x-6 gap-y-5">
                    <div className="w-full md:w-1/2 relative">
                        ...
                        Luxuriate in a tranquil environment as we cleanse, exfoliate, and nourish your skin, leaving you with a radiant and youthful complexion. From revitalizing facials to targeted skin treatments, embark on a journey of transformation and embrace the glow of confidence that comes from caring for your skin with utmost dedication.</p>
                            <h2 class="stock-heading-white  text-[2.75rem] lg:text-[4.5rem] 2xl:text-[6rem] md:text-left text-center w-full lg:w-fit absolute  top-1/2">Thai Luxary Spa</h2>
            ...
            <section id="section3" className="px-6 py-16">
                <div className="container mx-auto flex-col md:flex-row flex justify-center gap-x-6 gap-y-5">
                    ...
                    <div className="w-full md:w-1/2 relative z-10">
                        ...
                        <h2 className="stock-heading-white text-white text-[2.75rem] 2xl:text-[4rem] md:text-left text-center w-full lg:w-fit absolute -z-10 top-[70%] 2xl:top-1/2">
                            Spa & Massage
                        </h2>
                        <a href="#" className="text-white flex items-center justify-between max-w-[230px] pl-6 bg-[rgba(249,182,21,0.3)] border rounded-md text-xl border-[#f9b615] md:text-left text-center w-full absolute -z-10 top-[80%] 2xl:top-[60%]">
                            <p>Book Now</p>
                ...
                <div className="container mx-auto flex-col md:flex-row flex justify-center gap-x-6 gap-y-5">
                    <div className="w-full md:w-1/2 relative">
                        ...
                        Choose from a spectrum of trendy colors or classic hues from our premium nail polish collection for a polished finish that reflects your style. Step into a world of luxury and emerge with impeccably groomed nails and a renewed sense of well-being.</p>
                            <h2 class="stock-heading-white  text-[2.75rem] lg:text-[4.5rem] 2xl:text-[6rem] md:text-left text-center w-full lg:w-fit absolute  top-1/2">Rusy A Laurent</h2>
                    </div>
