    ...
    return <>
        <section className=" bg-black overflow-hidden">
                            ...
                            <div className="lg:w-full pr-4 pl-4">
                                <div className="tab-inner">
                                    ...
                                    <div className="py-16">
                                        ...
                                        <div className="mx-[10%]">
                                            <img className="inline-block align-middle w-full md:w-auto" src="https://cdn.pixabay.com/photo/2016/12/24/16/16/massage-1929064_1280.jpg" />
                                        </div>
            ...
            <section id="section2" className="px-6 py-16">
                <div className="tab-pane fade pt-0" id="key" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <div className="container mx-auto sm:px-4 max-w-full">
                        <div className="flex flex-wrap">
                            ...
                            <div className="md:w-4/5">
                                <div className="flex flex-wrap">
                                    <div className="lg:w-1/2 pr-4 pl-4 md:ml-0 md:pl-0">
                                        ...
                                        <div className="tab-pane-content text-white relative">
                                            ...
                                            <div className="p-[10px] sm:p-[30px] md:p-[60px] border-[1px] border-[#604d1d]">
                                                ...
                                                <ul>
                                                    ...
                                                    <li className="py-[6px]">Whether you're looking to relax, detoxify, or address specific skincare issues, we tailor our treatments to achieve your desired outcomes.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="lg:w-1/2 pr-4 pl-0 md:mr-0 md:pr-0">
                                        <div className="tab-img">
                                            <img className="max-w-[100%] h-auto" src="https://cdn.pixabay.com/photo/2017/10/27/16/45/cosmeatria-2894865_1280.jpg" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="md:w-4/5">
                                <div className="flex flex-wrap">
                                    <div className="lg:w-1/2 pr-4 pl-4 md:mr-0 md:pr-0">
                                        <div className="tab-img">
                                            <img className="max-w-[100%] h-auto" src="https://cdn.pixabay.com/photo/2022/12/05/04/15/ai-generated-7635895_1280.jpg" />
                                        </div>
                                    </div>
                                    <div className="lg:w-1/2 pr-4 pl-4 md:ml-0 md:pl-0">
                            ...
                            <div className="flex flex-wrap w-full md:w-1/2 z-9">
                                <div className="w-full relative z-10 md:pl-[62px] md:pt-10">
                                    ...
                                    <p className="text-white text-lg">Our customers are discerning in every aspect – and deservedly. <br /><br />
                                        ...
                                        In the realm of beauty care and pampering, amidst the plethora of choices, selecting the spa that promises impeccable skin, aroma, or serenity might result in significant challenges.<br /><br />

                                        Abandon the experimentation as our professionals have curated the pinnacle of services to assure that your upcoming therapy endeavor delivers nothing short of impeccable outcomes.</p>
                                </div>
                            </div>
            ...
            <div className="tab-pane fade pt-100 ftvConclu" id="conclu" role="tabpanel" aria-labelledby="nav-about-tab">
                            ...
                            <div className="px-4 md:px-0 w-full">
                                ...
                                <div className="font-Playfair futureB_box text-[#676b68]">
                                    <ul className="py-[4px] text-white">
                                        <li className="my-[12PX]">At Rusy & Laurent Spa, we believe that wellness is not just a luxury; it's a way of life. Our commitment to providing exceptional spa experiences stems from our passion for holistic health and rejuvenation. As you journey through our tranquil oasis, you'll discover a sanctuary where your mind, body, and spirit find harmony.</li>
                                        <li className="my-[12PX]">We take pride in offering a wide range of luxurious treatments tailored to meet your individual needs. Whether you seek relaxation, rejuvenation, or renewal, our team of skilled therapists is dedicated to delivering personalized care that exceeds your expectations.</li>
                                        <li className="my-[12PX]">Beyond our exceptional services, we strive to create an atmosphere of serenity and tranquility, where you can escape the stresses of everyday life and immerse yourself in pure bliss. From the moment you step through our doors, you'll be greeted with warmth and hospitality, ensuring that your time with us is nothing short of extraordinary.</li>
                                    </ul>
                                </div>
                                ...
                                <div className="font-Playfair futureB_box text-[#676b68]">
                                    ...
                                    <div className="flex flex-col text-white gap-y-2 mt-5 pb-4 mb-4">
                                        ...
                                        <p><span className="font-bold tracking-wide mr-2">Expert Therapists:</span> Our team of highly trained therapists is dedicated to providing personalized treatments tailored to your specific needs, ensuring the utmost care and attention throughout your spa journey.</p>
                                        <p><span className="font-bold tracking-wide mr-2">Premium Products:</span> Indulge in the finest quality products meticulously selected to enhance your experience, leaving your skin nourished, rejuvenated, and glowing.</p>
                                        <p><span className="font-bold tracking-wide mr-2">Customized Treatments:</span> From invigorating massages to revitalizing facials, our extensive range of treatments can be customized to address your unique preferences and concerns, promising a bespoke spa experience like no other.</p>
                                        <p><span className="font-bold tracking-wide mr-2">Private Suites:</span> Retreat to our luxurious private suites, where you can unwind in complete privacy and indulge in exclusive treatments tailored to your individual desires.</p>
                                        <p><span className="font-bold tracking-wide mr-2">Hydrotherapy Facilities:</span> Rejuvenate your body and mind with our state-of-the-art hydrotherapy facilities, including soothing hot tubs, invigorating steam rooms, and refreshing cold plunges, designed to enhance circulation and promote detoxification.</p>
                                        <p><span className="font-bold tracking-wide mr-2">Wellness Workshops:</span> Enrich your spa experience with our educational wellness workshops, where you can learn valuable techniques for self-care, stress management, and maintaining a healthy lifestyle long after your visit.
                                        </p>
                                        <p><span className="font-bold tracking-wide mr-2">Exceptional Service:</span> Experience the epitome of hospitality with our attentive staff who are committed to ensuring your comfort and satisfaction at every step of your spa journey.
                                        </p>
                                    </div>
